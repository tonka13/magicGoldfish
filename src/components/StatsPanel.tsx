...
import type { DrawnHand } from '../lib/types';
...
export default function StatsPanel({
  ...
  return (
    <>
      <div className="tiles">
        ...
        <div className="tile">
          <span className="label">
            Keepable ({keepableMin}–{keepableMax} lands)
          </span>
      ...
      <Histogram
        distribution={stats.landDistribution}
      ...
      <div className="table-wrap">
        <table>
          ...
          <tbody>
            {hands.map((hand, i) => {
              const a = analyzeHand(hand.cards, keepableMin, keepableMax);
              return (
                <tr key={i}>
